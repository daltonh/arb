...
" System flags
syn match arbSystemFlag "<<\%(axialdim\|azimuthal\|azimuthaldim\|batcher\|batchercomment\|nobatchercomment\|cartesiancomment\|cartesianflag\|cylindrical\|cylindricalcomment\|cylindricalflag\|dimensions\|dim1comment\|dim2comment\|dim3comment\|radialdim\|radius_c\|radius_f\|radius_n\|radiusdim1flag\|radiusdim2flag\|radiusdim3flag\|reflect=[1-3]\|relsteps\|steadystatecomment\|transientcomment\|transientsimulation\)>>"
...
" Functions
syn keyword arbFunction all associatedwith at boundaryof common compound cross domainof dot ddot fortran_float gmsh heaviside intersection kronecker mag none normal permutation signum surrounds union variable withinbox contained nextgroup=arbFunctionParen
syn keyword arbFunction cellave    cellfromcellave    cellfromcontextave    cellfromfaceave    cellfromnodeave    cellboundangle    celldelta    celldiv    cellfromcontextdiv    cellfromfacediv    celldivgrad    cellfromcontextdivgrad    cellfromfacedivgrad    cellgrad                        cellfromcontextgrad    cellfromfacegrad    cellfromnodegrad    cellif    celllimiter    celllink    cellmagnitude    cellmax    cellmin    cellnewtonupdate    cellproduct    cellsum    celltocelllink    celltocontextlink    celltofacelink    celltonodelink    contained nextgroup=arbFunctionBracket,arbFunctionParen
syn keyword arbFunction faceave    facefromcellave    facefromcontextave                                          faceboundangle    facedelta                                                                                                                        facegrad    facefromcellgrad    facefromcontextgrad                                            faceif                   facelink    facemagnitude    facemax    facemin    facenewtonupdate    faceproduct    facesum    facetocelllink    facetocontextlink    facetofacelink                      contained nextgroup=arbFunctionBracket,arbFunctionParen
syn keyword arbFunction nodeave    nodefromcellave    nodefromcontextave                                          nodeboundangle    nodedelta                                                                                                                        nodegrad    nodefromcellgrad    nodefromcontextgrad                                            nodeif                               nodemagnitude    nodemax    nodemin    nodenewtonupdate    nodeproduct    nodesum                                                                               contained nextgroup=arbFunctionBracket,arbFunctionParen
syn keyword arbFunction                                                                                           noneboundangle                                                                                                                                                                                                                                    noneif                               nonemagnitude    nonemax    nonemin    nonenewtonupdate    noneproduct    nonesum                                                                               contained nextgroup=arbFunctionBracket,arbFunctionParen
syn keyword arbFunction contextave contextfromcellave contextfromcontextave contextfromfaceave contextfromnodeave contextboundangle contextdelta contextdiv contextfromcontextdiv contextfromfacediv contextdivgrad contextfromcontextdivgrad contextfromfacedivgrad contextgrad contextfromcellgrad contextfromcontextgrad contextfromfacegrad contextfromnodegrad contextif contextlimiter contextlink contextmagnitude contextmax contextmin contextnewtonupdate contextproduct contextsum contexttocelllink contexttocontextlink contexttofacelink contexttonodelink contained nextgroup=arbFunctionBracket,arbFunctionParen
