...
let colors_name = "daltonh_macvim"
...
" hi Statement    gui=bold guifg=#733FFE guibg=NONE
" hi Statement    gui=bold guifg=#512CB5 guibg=NONE
  hi Statement    gui=bold guifg=#4940E5 guibg=NONE
...
" daltonh
" au FocusGained * if exists("colors_name") && colors_name == "macvim" | hi Visual guibg=blue | endif
