...
character(len=100) :: input_file ! fortran specific input file generated by the arb script, set in subroutine setup_dirs
character(len=100) :: output_dir ! path to the output_dir from the working_dir, set in subroutine setup_dirs
