...
integer :: iterstepcheck = 1 ! how often linear iteration solver checks for kill file and outputs to screen residuals etc
double precision :: newtrestol = 1.d-10 ! tolerance that indicates convergence of the newton proceedure
double precision :: iterrestol = 1.d-12 ! tolerance that indicates convergence of the linear iteration solver
